...
set shortmess=aoO
badd +30 ~/workspace_tb/Android_OpenGLDemo/src/opengl/demo/MyRenderer.java
silent! argdel *
edit ~/workspace_tb/Android_OpenGLDemo/src/opengl/demo/MyRenderer.java
...
setlocal tabstop=8
setlocal tags=~/.git/java.tags,~/.git/tags,./tags,./TAGS,tags,TAGS
